...
![](@/modules/changelog/images/commit-suggestions.png)
...
![](@/modules/changelog/images/configuration-files.png)
...
![](@/modules/changelog/images/dark-mode.png)
...
![](@/modules/changelog/images/first-release.png)
